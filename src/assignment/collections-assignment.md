...
Given an ArrayList of strings, count how many strings start with letter 'A'.
...
Use LinkedList as a Queue—enqueue and dequeue 5 integers.
...
Check performance: add/remove operations vs HashSet.
...
Store product → price. Update price of a product.
Find the key with highest value (e.g., highest marks).
Iterate HashMap using:
